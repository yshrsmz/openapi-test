...
data class StringOrInt(var actualInstance: Any? = null) {

    class CustomTypeAdapterFactory : TypeAdapterFactory {
        override fun <T> create(gson: Gson, type: TypeToken<T>): TypeAdapter<T>? {
            if (!StringOrInt::class.java.isAssignableFrom(type.rawType)) {
            ...
            return object : TypeAdapter<StringOrInt?>() {
                @Throws(IOException::class)
                override fun write(out: JsonWriter,value: StringOrInt?) {
                ...
                @Throws(IOException::class)
                override fun read(jsonReader: JsonReader): StringOrInt {
                    ...
                    throw IOException(String.format("Failed deserialization for StringOrInt: no schema match result. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()))
                }
    ...
    companion object {
        ...
        */
        ...
        fun validateJsonElement(jsonElement: JsonElement?) {
            ...
            if (match != 1) {
                throw IOException(String.format("Failed validation for StringOrInt: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()))
            }
        }
    }
}
